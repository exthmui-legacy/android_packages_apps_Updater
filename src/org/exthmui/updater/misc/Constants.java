...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.exthm.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    //public static final String PROP_BUILD_VERSION_CODE = "ro.exthm.versioncode";
    public static final String PROP_DEVICE = "ro.exthm.device";
